...
class _FridgeDetailScreenState extends State<FridgeDetailScreen> {
  ...
  final Color primaryColor = const  Color(0xFFF9F9F9); // Changed to match second code
  final Color textColor = const Color.fromARGB(255, 28, 98, 32); // Dark green for text
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color:  Color(0xFFDAF3D7), // Solid color like second code
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Icon(
                          ...
                          color: textColor, // Dark green like second code
                        ),
                      ),
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.search, color: textColor), // Dark green icon
                  filled: true,
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final typeColor = item['type']!.contains('صافي') ? Colors.green : Colors.orange;
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isExpanded
                                ? primaryColor.withOpacity(0.5) // More opaque like second code
                                : Colors.white,
                            borderRadius: BorderRadius.circular(16),
                            boxShadow: const [
                              BoxShadow(
                              ...
                              Row(
                                children: [
                                  Icon(
                                    ...
                                    color: textColor, // Dark green icon
                                    size: 24,
                                  ),
                                  const SizedBox(width: 8),
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 16,
                                      color: textColor, // Dark green text
                                    ),
                                  ),
                                ],
                              ),
